...
# Han: some TODOs
# 1. check whether we should set predict_eos_token for GPT2 and GPTNeo
# 2. check whether we should set add_special_tokens for GPT2 and GPTNeo
# 3. pay attention to the existing input_ids_len that can be helpful for locating soft prompts differently
