...
#     do
#       for LAMBDA in 0 0.003 0.01 0.03 0.1 0.3
#       do
#         for SEED in $(seq 0 1 10) # $(seq 0 1 4)
#         do
for LENGTH in 10
do
  ...
  do
    ...
    do
      ...
      do
        ...
        do
          MY_EXP_DIR="/private/home/swj0419/i-am-a-dog/openprompt-clone/swj_logging_dir/cb/gpt2-large/headprompt{$LENGTH}_LAMBDA{$LAMBDA}_LR{$LR}_NSTART{$NSTART}_NEND{$NEND}_SEED{$SEED}"
