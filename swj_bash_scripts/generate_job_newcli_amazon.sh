...
do
  ...
  do
    ...
    do
      ...
      do
        for ppl_loss_example_lambda in 0.0 0.05 0.2 0.5
        do
          ...
          do
            ...
            do
              ...
              do
                ...
                mkdir -p "/private/home/swj0419/i-am-a-dog/openprompt-clone/swj_logging_dir/new/amazon"
                # large batch size
                MY_EXP_DIR="/private/home/swj0419/i-am-a-dog/openprompt-clone/swj_logging_dir/new/amazon/gpt2-large/headprompt{$LENGTH}_ppl_loss_lambda{$ppl_loss_lambda}_ppl_loss_example_lambda{$ppl_loss_example_lambda}_task_loss_lambda{$task_loss_lambda}_entropy_loss_lambda{$entropy_loss_lambda}_LR{$LR}_NSTART{$NSTART}_NEND{$NEND}_SEED{$SEED}"
                echo "my_experiments/new_cli.py \
                    ...
                    --my_global_seed $SEED \
                    --prompt_num_tokens $LENGTH" >> hrpt.txt
              done
            done
          done
        done
