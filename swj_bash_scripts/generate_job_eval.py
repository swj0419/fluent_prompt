    ...
    with open(command_file, "w") as f:
        for i, line in df.iterrows():
            ...
            for MODEL in ["gpt2-xl", "EleutherAI/gpt-neo-2.7B"]:
                EVAL_DIR = f"/private/home/swj0419/i-am-a-dog/openprompt-clone/swj_logging_dir/sst2/eval/{MODEL}/headprompt_{round(INDEX, 2)}_ACC:{round(ACC, 2)}_PPL:{round(PPL, 2)}"
