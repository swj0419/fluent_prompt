    ...
    do
      ...
      do
        ...
        do
          ...
          MY_EXP_DIR="/private/home/swj0419/i-am-a-dog/openprompt-clone/swj_logging_dir/amazon/gpt2-large_soft/headprompt{$LENGTH}_LAMBDA{$LAMBDA}_LR{$LR}_NSTART{$NSTART}_NEND{$NEND}_SEED{$SEED}"
          ...
          echo "my_experiments/soft_cli.py \
              ...
              --my_global_seed $SEED \
              --prompt_num_tokens $LENGTH" >> hrpt_amazon_soft.txt
