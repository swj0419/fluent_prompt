    ...
    do
      ...
      do
        ...
        do
          ...
          MY_EXP_DIR="/private/home/swj0419/i-am-a-dog/openprompt-clone/swj_logging_dir2/amazon/gpt2-large/headprompt{$LENGTH}_LAMBDA{$LAMBDA}_LR{$LR}_NSTART{$NSTART}_NEND{$NEND}_SEED{$SEED}"
          mkdir -p $MY_EXP_DIR
          ...
          echo "my_experiments/cli.py \
              ...
              --my_global_seed $SEED \
              --prompt_num_tokens $LENGTH;$MY_EXP_DIR/checkpoints" >> hrpt_amazon.txt
